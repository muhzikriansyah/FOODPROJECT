...
/****** Object:  Database [OnlineFoodOrderingSystem]    Script Date: 29/04/2021 04:00:10 ******/
CREATE DATABASE [OnlineFoodOrderingSystem]
 CONTAINMENT = NONE
 ON  PRIMARY 
( NAME = N'OnlineFoodOrderingSystem', FILENAME = N'C:\Program Files\Microsoft SQL Server\MSSQL15.MSSQLSERVER\MSSQL\DATA\OnlineFoodOrderingSystem.mdf' , SIZE = 8192KB , MAXSIZE = UNLIMITED, FILEGROWTH = 65536KB )
 LOG ON 
( NAME = N'OnlineFoodOrderingSystem_log', FILENAME = N'C:\Program Files\Microsoft SQL Server\MSSQL15.MSSQLSERVER\MSSQL\DATA\OnlineFoodOrderingSystem_log.ldf' , SIZE = 8192KB , MAXSIZE = 2048GB , FILEGROWTH = 65536KB )
...
ALTER DATABASE [OnlineFoodOrderingSystem] SET RECOVERY FULL 
GO
...
ALTER DATABASE [OnlineFoodOrderingSystem] SET FILESTREAM( NON_TRANSACTED_ACCESS = OFF ) 
GO

ALTER DATABASE [OnlineFoodOrderingSystem] SET TARGET_RECOVERY_TIME = 60 SECONDS 
GO

ALTER DATABASE [OnlineFoodOrderingSystem] SET DELAYED_DURABILITY = DISABLED 
GO

ALTER DATABASE [OnlineFoodOrderingSystem] SET ACCELERATED_DATABASE_RECOVERY = OFF  
GO

ALTER DATABASE [OnlineFoodOrderingSystem] SET QUERY_STORE = OFF
GO
